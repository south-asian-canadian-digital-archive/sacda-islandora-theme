...
function Hello_test(o, F) {
	...
	return reset(z), html(sibling(z, 8), () => `<style>${app_default}</style>`), template_effect(() => set_text(B, `Hello ${I() ?? ""}!`)), append(o, R), pop(L);
}
